...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5936218287188409944L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Key\",\"namespace\":\"postgres.demo.account_owner\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"long\",\"connect.default\":0},\"default\":0}],\"connect.name\":\"postgres.demo.account_owner.Key\"}");
   ...
   */
  public static postgres.demo.account_owner.Key.Builder newBuilder() {
    return new postgres.demo.account_owner.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static postgres.demo.account_owner.Key.Builder newBuilder(postgres.demo.account_owner.Key.Builder other) {
    if (other == null) {
      return new postgres.demo.account_owner.Key.Builder();
    } else {
      return new postgres.demo.account_owner.Key.Builder(other);
    }
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static postgres.demo.account_owner.Key.Builder newBuilder(postgres.demo.account_owner.Key other) {
    if (other == null) {
      return new postgres.demo.account_owner.Key.Builder();
    } else {
      return new postgres.demo.account_owner.Key.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Key>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(postgres.demo.account_owner.Key.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(postgres.demo.account_owner.Key other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.demo.account_owner.Key.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.demo.account_owner.Key.Builder clearId() {
